...
type UserServiceClient interface {
	...
	GetUsers(ctx context.Context, in *Nil, opts ...grpc.CallOption) (*UsersResponse, error)
}
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *Nil, opts ...grpc.CallOption) (*UsersResponse, error) {
...
type UserServiceServer interface {
	...
	GetUsers(context.Context, *Nil) (*UsersResponse, error)
...
func (UnimplementedUserServiceServer) GetUsers(context.Context, *Nil) (*UsersResponse, error) {
...
func _UserService_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUsers(ctx, req.(*Nil))
	}
	return interceptor(ctx, in, info, handler)
}
